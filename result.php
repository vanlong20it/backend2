...
$productList = $productModels->searchProduct($keyword);
...
<body>
  ...
  <header class="top-header">
    ...
    <?php 
        echo "<center>";
            echo "<h3>Search result for '$keyword'<h3>" . "<br>";
        echo "</center>";
    ?>
     <div class="drones">
      <div class="container">
        <div class="row">
          <div class="col-md-3 category">
            ...
            <div class="col-md-4 format">
                <div class="item">
                    <img class = "img-fluid" src="<?php echo BASE_URL; ?>/public/images/<?php echo $item['product_image'];?>">
                    <a href="<?php echo BASE_URL; ?>/product.php?id=<?php echo $item['product_id'];?>" class="none-decor">
                        <h5><?php echo $item['product_name'];?></h5>
                    </a>
                <p><?php echo "$".$item['product_price'];?></p>
                <a href="<?php echo BASE_URL; ?>/cart.php?id=<?php echo $item['product_id'];?>" class="btn btn-add"><i class="fas fa-shopping-cart"></i> Add to cart</a>
                </div>
            </div>
                <?php 
                    }
